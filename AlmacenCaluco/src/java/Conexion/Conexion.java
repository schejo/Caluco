    ...
    public Connection Conexion() throws SQLException {
        ...
        try {
           ...
           // cnx = DriverManager.getConnection("jdbc:mysql://localhost:3306/almacen?allowPublicKeyRetrieval=true&serverTimezone=UTC&useSSL=false", "root", "root");
            //cnx = DriverManager.getConnection("jdbc:mysql://localhost:3306/almacen?allowPublicKeyRetrieval=true&serverTimezone=UTC&useSSL=false", "root", "root");
             cnx = DriverManager.getConnection("jdbc:mysql://db-mysql-nyc1-13705-do-user-12423640-0.b.db.ondigitalocean.com:25060/almacen?allowPublicKeyRetrieval=true&serverTimezone=UTC&useSSL=false", "caluco", "AVNS_HSmsBW3gYs0lkszEsry");
